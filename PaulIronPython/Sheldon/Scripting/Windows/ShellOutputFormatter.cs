...
namespace Sheldon.Scripting.Windows
{
    ...
    /// </summary>
    public class ShellOutputFormatter : IShellOutputFormatter
    {
        private bool _lastNewlineWasDelayed;

        /// <summary>
        /// Initializes a new instance of the <see cref="ShellOutputFormatter"/> class.
        /// </summary>
        public ShellOutputFormatter()
        {
        }
        ...
        /// </returns>
        public FormattedOutput Format(string text, ConsoleColor? currentConsoleColor, IEnumerable<ShellColorMapping> mappings)
        {
