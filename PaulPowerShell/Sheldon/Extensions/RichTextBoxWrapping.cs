...
namespace Sheldon.Extensions
{
    ...
    {
        public static readonly DependencyProperty TextWrappingBasedOnTextProperty = DependencyProperty.RegisterAttached("TextWrappingBasedOnText", typeof(string), typeof(RichTextBoxWrapping), new UIPropertyMetadata(string.Empty, Remeasure));
        public static readonly DependencyProperty TextWrappingProperty = DependencyProperty.RegisterAttached("TextWrapping", typeof(TextWrapping), typeof(RichTextBoxWrapping), new UIPropertyMetadata(TextWrapping.NoWrap, Remeasure));
        ...
        private static void Remeasure(DependencyObject target, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (GetTextWrapping(target) == TextWrapping.NoWrap)
            {
                var text = GetTextWrappingBasedOnText(target) ?? string.Empty;
